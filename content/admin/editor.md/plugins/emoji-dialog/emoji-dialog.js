                    ...
                    for (var i = 0; i < pageTotal; i++)
                    {
                        ...
                        for (var x = 0; x < rowNumber; x++)
                        {
                            ...
                            if (typeof emoji !== "undefined" && emoji !== "")
                            {
                                ...
                                {
                                    var mapped = (exports.emojiMap && exports.emojiMap[emoji]) ? exports.emojiMap[emoji] : "";
                                    if (mapped && /^https?:\/\//i.test(mapped)) {
                                        img = "<img src=\"" + mapped + "\" width=\"24\" class=\"emoji\" title=\"&#58;" + emoji + "&#58;\" alt=\"&#58;" + emoji + "&#58;\" />";
                                    } else if (mapped) {
                                        img = "<span class=\"emoji\" style=\"font-size:22px;line-height:1;\" title=\"&#58;" + emoji + "&#58;\">" + mapped + "</span>";
                                    } else {
                                        img = "<span class=\"emoji\" title=\"&#58;" + emoji + "&#58;\">:" + emoji + ":</span>";
                                    }
                                    var insertVal = mapped && !/^https?:\/\//i.test(mapped) ? mapped : (":" + emoji + ":");
                                    row += "<a href=\"javascript:;\" value=\"" + insertVal + "\" title=\":" + emoji + ":\" class=\"" + classPrefix + "emoji-btn\">" + img + "</a>";
                                }
                                else if (type === "twemoji")
                                {
                                    var twChar = exports.hexToEmoji ? exports.hexToEmoji(emoji) : "";
                                    if (twChar) {
                                        img = "<span class=\"emoji twemoji\" style=\"font-size:22px;line-height:1;\" title=\"twemoji-" + emoji + "\">" + twChar + "</span>";
                                    } else {
                                        img = "<span title=\"twemoji-" + emoji + "\">:" + emoji + ":</span>";
                                    }
                                    row += "<a href=\"javascript:;\" value=\"" + (twChar || (":tw-" + emoji + ":")) + "\" title=\":tw-" + emoji + ":\" class=\"" + classPrefix + "emoji-btn\">" + img + "</a>";
                                }
			...
			{            
                ...
                var loadList = function () {
                    $.getJSON(path + "emoji.json?temp=" + Math.random(), function(json) {
                        ...
                        emojiData = {"github-emoji": [], "twemoji": [], "font-awesome": []};
                        emojiData[logoPrefix] = logos;
                        finishLoad();
                    });
                };
                ...
                if (exports.emojiMap) {
                    loadList();
                } else if (typeof exports.loadEmojiMap === "function") {
                    exports.loadEmojiMap(settings.pluginPath, loadList);
                } else {
                    $.getJSON(path + "emoji-unicode.json?temp=" + Math.random(), function (json) {
                        exports.emojiMap = json || {};
                        loadList();
                    }).fail(function () {
                        exports.emojiMap = {};
                        loadList();
