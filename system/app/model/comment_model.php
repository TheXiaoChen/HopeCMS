...
class Comment_Model {
    ...
    function getComments($blogId = null, $hide = null, $page = null) {
        ...
        if (Option::get('comment_paging') == 'y') {
            ...
            if (Option::get('linkmode') == 0 && strpos($pageurl, '=') !== false) {
    ...
    function getCommentsForAdmin($blogId = null, $uid = null, $hide = null, $page = null, $per_page_num = 20) {
        ...
        $sql = "SELECT *,a.hide,a.date,a.top FROM " . DB_PREFIX . "comment as a, " . DB_PREFIX . "article as b where $andQuery and a.gid=b.gid $orderBy $condition";
    ...
    function getCommentNum($blogId = null, $uid = null, $hide = null) {
        ...
        if (User::haveEditPermission()) {
            ...
            $sql = "SELECT count(*) FROM " . DB_PREFIX . "comment as a, " . DB_PREFIX . "article as b where $andQuery and a.gid=b.gid and b.author=" . UID;
        }
    ...
    function updateCommentNum($blogId) {
        if (is_array($blogId)) {
            ...
            $res = $this->db->once_fetch_array($sql);
            $comNum = $res['count(*)'];
            $this->db->query("UPDATE " . DB_PREFIX . "article SET comnum=$comNum WHERE gid=$blogId");
            return $comNum;
        }
    }
    ...
    function addComment($uid, $name, $content, $mail, $url, $blogId, $pid) {
        ...
        if ($hide === 'n') {
            $this->db->query('UPDATE ' . DB_PREFIX . "article SET comnum = comnum + 1 WHERE gid='$blogId'");
    ...
    function isYoursComment($cid) {
        ...
        $query = $this->db->query("SELECT a.cid FROM " . DB_PREFIX . "comment as a," . DB_PREFIX . "article as b WHERE a.cid=$cid and a.gid=b.gid AND b.author=" . UID);
