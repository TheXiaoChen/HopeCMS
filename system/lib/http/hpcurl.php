<?php
/**
 * Hope CMS(希望CMS) curl wrapper class
...
class HpCurl {
    ...
    public function request($url = 'nul') {
        ...
        curl_setopt($s, CURLOPT_USERAGENT, $this->_useragent . Option::HOPE_VERSION);
