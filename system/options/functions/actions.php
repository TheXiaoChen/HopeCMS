...
if ( ! function_exists( 'csf_get_icons' ) ) {
  function csf_get_icons() {
    ...
    if ( ! empty( $icon_lists ) ) {
      ...
      foreach ( $icon_lists as $list ) {
        ...
        echo ( count( $icon_lists ) >= 2 ) ? '<div class="hope-icon-title">'. esc_attr( $list['title'] ) .'</div>' : '';
      ...
      echo '<div class="hope-error-text">'. esc_html__( 'No data available.', 'csf' ) .'</div>';
  ...
  //add_action( 'wp_ajax_hope-get-icons', 'csf_get_icons' );
}
...
if ( ! function_exists( 'csf_export' ) ) {
  ...
  //add_action( 'wp_ajax_hope-export', 'csf_export' );
}
...
if ( ! function_exists( 'csf_import_ajax' ) ) {
  ...
  //add_action( 'wp_ajax_hope-import', 'csf_import_ajax' );
}
...
if ( ! function_exists( 'csf_reset_ajax' ) ) {
  ...
  //add_action( 'wp_ajax_hope-reset', 'csf_reset_ajax' );
}
...
if ( ! function_exists( 'csf_chosen_ajax' ) ) {
  ...
  //add_action( 'wp_ajax_hope-chosen', 'csf_chosen_ajax' );
}
