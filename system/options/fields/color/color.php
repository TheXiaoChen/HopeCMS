...
if (!class_exists('CSF_Field_color')) {
  class CSF_Field_color extends CSF_Fields
  {
    ...
    public function render()
    {
      ...
      echo '<div class="hope-flex">';
      echo '<input type="text" name="' . esc_attr($this->field_name()) . '" value="' . esc_attr($this->value) . '" class="hope-color"' . $default_attr . $this->field_attributes() . '/>';
      echo '</div>';
