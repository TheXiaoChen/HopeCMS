...
if ( ! class_exists( 'CSF_Field_typography' ) ) {
  class CSF_Field_typography extends CSF_Fields {
    ...
    public function render() {
      ...
      $chosen_class     = ( $this->chosen ) ? ' hope--chosen' : '';
      $line_height_unit = ( ! empty( $args['line_height_unit'] ) ) ? $args['line_height_unit'] : $args['unit'];

      echo '<div class="hope--typography'. esc_attr( $chosen_class ) .'" data-unit="'. esc_attr( $args['unit'] ) .'" data-line-height-unit="'. esc_attr( $line_height_unit ) .'" data-exclude="'. esc_attr( $args['exclude'] ) .'">';

        echo '<div class="hope--blocks hope--blocks-selects">';

          //
          // Font Family
          if ( ! empty( $args['font_family'] ) ) {
            echo '<div class="hope--block">';
            echo '<div class="hope--title">'. esc_html__( 'Font Family', 'csf' ) .'</div>';
          ...
          if ( ! empty( $args['backup_font_family'] ) ) {
            echo '<div class="hope--block hope--block-backup-font-family hidden">';
            echo '<div class="hope--title">'. esc_html__( 'Backup Font Family', 'csf' ) .'</div>';
          ...
          if ( ! empty( $args['font_weight'] ) || ! empty( $args['font_style'] ) ) {
            ...
            //
            // Font Style Select
            echo '<div class="hope--block hope--block-font-style hidden">';
            echo '<div class="hope--title">'. esc_html__( 'Font Style', 'csf') .'</div>';
            echo '<select class="hope--font-style-select" data-placeholder="Default">';
            ...
            echo '</select>';
            echo '<input type="hidden" name="'. esc_attr( $this->field_name( '[font-weight]' ) ) .'" class="hope--font-weight" value="'. esc_attr( $this->value['font-weight'] ) .'" />';
            echo '<input type="hidden" name="'. esc_attr( $this->field_name( '[font-style]' ) ) .'" class="hope--font-style" value="'. esc_attr( $this->value['font-style'] ) .'" />';

            //
            // Extra Font Style Select
            if ( ! empty( $args['extra_styles'] ) ) {
              echo '<div class="hope--block-extra-styles hidden">';
              echo ( ! $this->chosen ) ? '<div class="hope--title">'. esc_html__( 'Load Extra Styles', 'csf' ) .'</div>' : '';
          ...
          if ( ! empty( $args['subset'] ) ) {
            echo '<div class="hope--block hope--block-subset hidden">';
            echo '<div class="hope--title">'. esc_html__( 'Subset', 'csf' ) .'</div>';
          ...
          if ( ! empty( $args['text_align'] ) ) {
            echo '<div class="hope--block">';
            echo '<div class="hope--title">'. esc_html__( 'Text Align', 'csf' ) .'</div>';
          ...
          if ( ! empty( $args['font_variant'] ) ) {
            echo '<div class="hope--block">';
            echo '<div class="hope--title">'. esc_html__( 'Font Variant', 'csf' ) .'</div>';
            echo $this->create_select( array(
          ...
          if ( ! empty( $args['text_transform'] ) ) {
            echo '<div class="hope--block">';
            echo '<div class="hope--title">'. esc_html__( 'Text Transform', 'csf' ) .'</div>';
            echo $this->create_select( array(
          ...
          if ( ! empty( $args['text_decoration'] ) ) {
            echo '<div class="hope--block">';
            echo '<div class="hope--title">'. esc_html__( 'Text Decoration', 'csf' ) .'</div>';
            echo $this->create_select( array(
              'none'               => esc_html__( 'None', 'csf' ),
        ...
        echo '<div class="hope--blocks hope--blocks-inputs">';

          //
          // Font Size
          if ( ! empty( $args['font_size'] ) ) {
            echo '<div class="hope--block">';
            echo '<div class="hope--title">'. esc_html__( 'Font Size', 'csf' ) .'</div>';
            echo '<div class="hope--input-wrap">';
            echo '<input type="number" name="'. esc_attr( $this->field_name( '[font-size]' ) ) .'" class="hope--font-size hope--input hope-input-number" value="'. esc_attr( $this->value['font-size'] ) .'" step="any" />';
            echo '<span class="hope--unit">'. esc_attr( $args['unit'] ) .'</span>';
            echo '</div>';
            echo '</div>';
          }
          ...
          if ( ! empty( $args['line_height'] ) ) {
            echo '<div class="hope--block">';
            echo '<div class="hope--title">'. esc_html__( 'Line Height', 'csf' ) .'</div>';
            echo '<div class="hope--input-wrap">';
            echo '<input type="number" name="'. esc_attr( $this->field_name( '[line-height]' ) ) .'" class="hope--line-height hope--input hope-input-number" value="'. esc_attr( $this->value['line-height'] ) .'" step="any" />';
            echo '<span class="hope--unit">'. esc_attr( $line_height_unit ) .'</span>';
            echo '</div>';
            echo '</div>';
          }
          ...
          if ( ! empty( $args['letter_spacing'] ) ) {
            echo '<div class="hope--block">';
            echo '<div class="hope--title">'. esc_html__( 'Letter Spacing', 'csf' ) .'</div>';
            echo '<div class="hope--input-wrap">';
            echo '<input type="number" name="'. esc_attr( $this->field_name( '[letter-spacing]' ) ) .'" class="hope--letter-spacing hope--input hope-input-number" value="'. esc_attr( $this->value['letter-spacing'] ) .'" step="any" />';
            echo '<span class="hope--unit">'. esc_attr( $args['unit'] ) .'</span>';
            echo '</div>';
            echo '</div>';
          }
          ...
          if ( ! empty( $args['word_spacing'] ) ) {
            echo '<div class="hope--block">';
            echo '<div class="hope--title">'. esc_html__( 'Word Spacing', 'csf' ) .'</div>';
            echo '<div class="hope--input-wrap">';
            echo '<input type="number" name="'. esc_attr( $this->field_name( '[word-spacing]' ) ) .'" class="hope--word-spacing hope--input hope-input-number" value="'. esc_attr( $this->value['word-spacing'] ) .'" step="any" />';
            echo '<span class="hope--unit">'. esc_attr( $args['unit'] ) .'</span>';
            echo '</div>';
            echo '</div>';
          }
        ...
        if ( ! empty( $args['color'] ) ) {
          ...
          echo '<div class="hope--block hope--block-font-color">';
          echo '<div class="hope--title">'. esc_html__( 'Font Color', 'csf' ) .'</div>';
          echo '<div class="hope-field-color">';
          echo '<input type="text" name="'. esc_attr( $this->field_name( '[color]' ) ) .'" class="hope-color hope--color" value="'. esc_attr( $this->value['color'] ) .'"'. $default_color_attr .' />';
          echo '</div>';
          echo '</div>';
        }
        ...
        if ( ! empty( $args['custom_style'] ) ) {
          echo '<div class="hope--block hope--block-custom-style">';
          echo '<div class="hope--title">'. esc_html__( 'Custom Style', 'csf' ) .'</div>';
          echo '<textarea name="'. esc_attr( $this->field_name( '[custom-style]' ) ) .'" class="hope--custom-style">'. esc_attr( $this->value['custom-style'] ) .'</textarea>';
          echo '</div>';
        }
        ...
        if ( ! empty( $args['preview'] ) ) {
          echo '<div class="hope--block hope--block-preview'. esc_attr( $always_preview ) .'">';
          echo '<div class="hope--toggle fas fa-toggle-off"></div>';
          echo '<div class="hope--preview">'. esc_attr( $args['preview_text'] ) .'</div>';
          echo '</div>';
        }

        echo '<input type="hidden" name="'. esc_attr( $this->field_name( '[type]' ) ) .'" class="hope--type" value="'. esc_attr( $this->value['type'] ) .'" />';
        echo '<input type="hidden" name="'. esc_attr( $this->field_name( '[unit]' ) ) .'" class="hope--unit-save" value="'. esc_attr( $args['unit'] ) .'" />';
    ...
    public function create_select( $options, $name, $placeholder = '', $is_multiple = false ) {
      ...
      $output  = '<select name="'. esc_attr( $this->field_name( '['. $name .']'. $multiple_name ) ) .'" class="hope--'. esc_attr( $name ) . esc_attr( $chosen_rtl ) .'" data-placeholder="'. esc_attr( $placeholder ) .'"'. $multiple_attr .'>';
    ...
    public function enqueue() {
      ...
      if ( ! wp_script_is( 'hope-webfontloader' ) ) {

        CSF::include_plugin_file( 'fields/typography/google-fonts.php' );

        wp_enqueue_script( 'hope-webfontloader', 'https://cdn.jsdelivr.net/npm/webfontloader@1.6.28/webfontloader.min.js', array( 'csf' ), '1.6.28', true );
